...
function SuppliersTable() {
  ...
  useEffect(() => {
    axios({
      method: 'post',
      url: 'http://localhost:5000/supTableRoute/getSupTable',
    })
      .then(response => {
  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <Link to="/suppliersForm" element={<SuppliersForm />}>
          <Button variant="contained" color="primary" startIcon={<AddIcon />}>
            Add New
          </Button>
        </Link>
        <Link to="/dashboard" element={<Suppliers />}>
